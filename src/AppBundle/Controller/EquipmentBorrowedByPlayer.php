...
class EquipmentBorrowedByPlayerController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($equipmentBorrowedByPlayer)
			...
			->add('EquipmentId', IntegerType::class)            
    ...
    public function viewallAction( Request $request)
    {
        ...
        return $this->render('equipmentBorrowedByPlayer/viewall.html.twig', array('equipmentBorrowedByPlayer' => $equipmentBorrowedByPlayer));
